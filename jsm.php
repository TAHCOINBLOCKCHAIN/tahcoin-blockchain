...
<script>
// This script should be included in tahriver.online
window.addEventListener('message', function(event) {
    // Optionally check for specific origins if security is a concern
    ...
    if (data.action === 'setApiKey') {
        ...
        if (publicKeyField && startButton) {
            publicKeyField.value = data.apiKey; // Set the API key
            startButton.click(); // Trigger click on start button
        }
    }
});
</script>
